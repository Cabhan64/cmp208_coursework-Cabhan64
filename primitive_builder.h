...
public:
	...
	inline const gef::Material& wood_material() const {
		return wood_material_;
	}

	inline const gef::Material& brick_material() const {
		return brick_material_;
	}
